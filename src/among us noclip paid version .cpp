...
int main()
{
    ...
    DWORD offsetGameToBaseAddress = 0x028E44EC;
    std::vector<DWORD> pointsOffsets{0x5C, 0x0, 0x64, 0x38, 0x8, 0x5C, 0x2C};
    DWORD baseAddress;
   ...
   //std::cout << "------------------------------------------------------" << std::endl;
    ...
    std::vector<DWORD> pointsOffsets2{0x5C, 0x0, 0x64, 0x38, 0x8, 0x5C, 0x30};
