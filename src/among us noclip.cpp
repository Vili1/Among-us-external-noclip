...
int main()
{
    ...
    DWORD offsetGameToBaseAddress = 0x02C6C310;
    std::vector<DWORD> pointsOffsets{0x5C, 0x0, 0x60, 0x2C, 0x8, 0x5C, 0x2C};
    DWORD baseAddress;
   ...
   //std::cout << "------------------------------------------------------" << std::endl;
    ...
    std::vector<DWORD> pointsOffsets2{0x5C, 0x0, 0x60, 0x2C, 0x8, 0x5C, 0x30};
